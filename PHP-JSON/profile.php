...
$avatar = $user["avatar"];    //ստանալ բոլոր avatar-ները
...
<div class="container mt-4">
    <div class="row">
        <div class="offset-2 col-4">
            <div class="prof_img">
                ...
                if($avatar == null) {                                   //եթե avatar չկա դրած profile-ի նկարը կլինի
                    echo "<img src='Images/avatars/boy.png' class='profile_img' width='340' height='250'>";
                } else {
                    echo "<img src='Images/avatars/$avatar' class='profile_img' width='340' height='250'>";
                }
                if (isset($avatar)){?>
            ...
            <form action="profileImg.php" method="post" enctype="multipart/form-data">
                <label id="one" class="btn btn-primary" style="position: absolute; bottom: 45px; right: 170px">
        ...
        <div class="col-4">
            ...
            echo "Phone Number: ".$user["tel"]."<br>";
            echo "E-mail: ".$user["email"]."<br>";
            echo "Birthday: ".$user["bday"]."<br>";
    ...
    <div class="row">
        ...
        <div class="col-10">
          <div class="row">
            <?php
            $readUsersJson = file_get_contents("db/gallery.json"); //json ֆայլը կարդալու համար
            $galleriesArray = json_decode($readUsersJson, true); //ձևափոխի json տեքստը ասոցիատիվ array.
            ...
            ?>
            <div class="col-4">
                <img src="Images/gallery/<?=$userGalleries[$i]["img"]?>" alt="" width="100%" height="190">
                <a href="galleryDelete.php?gallery_id=<?=$userGalleries[$i]['id']?>" class="btn btn-danger" style="position: absolute; top: 5px; right: 20px" title="Delete">
                    <i class="fas fa-trash-alt"></i>
                </a>
                <a href="galleryProfile.php?gallery_id=<?=$userGalleries[$i]['id']?>" class="btn btn-info" style="position: absolute; bottom: 5px;right: 135px" title="Add profile">
